...
const theme = (darkMode, color) => ({
  ...
  concreteGray: darkMode ? '#292C2F' : '#ffffff',
  inputBackground: darkMode ? '#1F1F1F' : '#ffffff',
  shadowColor: darkMode ? '#000' : '#8472e8',
  mercuryGray: darkMode ? '#333333' : '#E1E1E1',

  text1: darkMode ? '#ffffff' : '#1F1F1F',
  text2: darkMode ? '#7b6be2' : '#565A69',
  text3: darkMode ? '#8472e8' : '#888D9B',
  ...
  //primary colors
  primary1: darkMode ? '#8472e8' : '#ff007a',
