...
const Wrapper = styled.div`
  ...
  box-shadow: ${({ open, small }) =>
    !open && !small
      ? '0px 24px 32px rgba(0, 0, 0, 0.04), 0px 16px 24px rgba(121 105 222), 0px 4px 8px rgba(121 105 222), 0px 0px 1px rgba(0, 0, 0, 0.04) '
      : 'none'};
...
const Menu = styled.div`
  ...
  box-shadow: 0px 0px 1px rgba(121 105 222), 0px 4px 8px rgba(121 105 222), 0px 16px 24px rgba(121 105 222),
    0px 24px 32px rgba(121 105 222);
        ...
        <Input
          ...
          placeholder={
            small
              ...
              : 'Search Mainnetz pairs and tokens...'
          }
          value={value}
          onChange={e => {
        ...
        <div>
          ...
          {filteredPairList &&
            filteredPairList.slice(0, pairsShown).map(pair => {
              if (pair?.token0?.id === '0xd7b21500dff3d5578b21ebf7f25be806087559a7') {
                pair.token0.name = 'NETZ (Wrapped)'
                pair.token0.symbol = 'NETZ'
              }
              if (pair?.token1.id === '0xd7b21500dff3d5578b21ebf7f25be806087559a7') {
                pair.token1.name = 'NETZ (Wrapped)'
                pair.token1.symbol = 'NETZ'
              }
              return (
