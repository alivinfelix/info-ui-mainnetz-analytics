...
export const priceOverrides = [
  '0x122af3264184aa0d1a8f1cbd01eb3a31fc6118f5', // USDC
  '0x48d0b489f9be6416b2b7b690dc1ac6f22352da75' // DAI
]
...
const PRICE_DISCOVERY_START_TIMESTAMP = 1672520522
...
function formatPricesForEarlyTimestamps(position): Position {
  if (position.timestamp < PRICE_DISCOVERY_START_TIMESTAMP) {
    ...
    // WETH price
    if (position.pair?.token0.id === '0x41c515fa7d541bcbdefb44f0fe2b1629aec140b9') {
      position.token0PriceUSD = 203
    }
    if (position.pair?.token1.id === '0x41c515fa7d541bcbdefb44f0fe2b1629aec140b9') {
